    ...
    def __getitem__(self, index_tuple):
        ...
        for _ in range(MAX_RETRY_NUMS):
            try:
                ...
                raw_image_win = self.transform_img(raw_image_win, original_size=(img_h, img_w), target_size= target_size )
                raw_image_lose = self.transform_img(raw_image_lose, original_size=(img_h, img_w), target_size= target_size )
                ...
                return {"image_win": raw_image_win, "image_lose": raw_image_lose, "ref_image":ref_image, "prompt": prompt, 'input_ids': input_ids, 'attention_mask': attention_mask, 'pixel_values':pixel_values, 'image_grid_thw':image_grid_thw}
